...
ALTER TABLE ONLY public.docenteEntity DROP CONSTRAINT docente_pid_fkey;
...
ALTER TABLE ONLY public.materiaEntity DROP CONSTRAINT materia_pkey;
ALTER TABLE ONLY public.materiaEntity DROP CONSTRAINT materia_nombre_key;
...
ALTER TABLE ONLY public.docenteEntity DROP CONSTRAINT docente_pkey;
ALTER TABLE ONLY public.docenteEntity DROP CONSTRAINT docente_legajo_key;
...
ALTER TABLE public.materiaEntity ALTER COLUMN mid DROP DEFAULT;
...
DROP TABLE public.materiaEntity;
DROP TABLE public.inscripcion;
DROP TABLE public.docenteEntity;
...
CREATE FUNCTION public.fn_savemateria(pin_mid integer, pin_nombre character varying, pin_descripcion text) RETURNS integer
  ...
  BEGIN
    IF (var_mid IS NULL) THEN
      -- no existe ==> insert
      INSERT INTO materiaEntity(nombre, descripcion)
        VALUES (var_nombre, pin_descripcion)
        RETURNING mid INTO var_mid;
    ELSE
      -- sí existe ==> update
      UPDATE materiaEntity SET
        nombre = var_nombre,
        descripcion = pin_descripcion
      WHERE mid = var_mid;
    END IF;
...
CREATE FUNCTION public.pr_deletedocente(pin_pid integer) RETURNS void
  ...
  BEGIN
    DELETE FROM docenteEntity WHERE pid = pin_pid;
...
CREATE FUNCTION public.pr_deletemateria(pin_mid integer) RETURNS void
  ...
  BEGIN
    DELETE FROM materiaEntity WHERE mid = pin_mid;
  END;
...
CREATE FUNCTION public.pr_savedocente(pin_pid integer, pin_legajo character varying) RETURNS void
  ...
  BEGIN
    ...
    IF (var_count = 0) THEN
      -- no existe ==> insert
      INSERT INTO docenteEntity(pid, legajo) VALUES (pin_pid, var_legajo);

    ELSE
      -- sí existe ==> update
      UPDATE docenteEntity SET legajo = var_legajo WHERE pid = pin_pid;
    END IF;
...
--
-- Name: docenteEntity; Type: TABLE; Schema: public; Owner: sacusr
--

CREATE TABLE public.docenteEntity (
    pid integer NOT NULL,
    legajo character varying(16) NOT NULL
);


ALTER TABLE public.docenteEntity OWNER TO sacusr;
...
--
-- Name: materiaEntity; Type: TABLE; Schema: public; Owner: sacusr
--

CREATE TABLE public.materiaEntity (
    mid integer NOT NULL,
    nombre character varying(64) NOT NULL,
    descripcion text
);
...
ALTER TABLE public.materiaEntity OWNER TO sacusr;
...
ALTER SEQUENCE public.materia_mid_seq OWNED BY public.materiaEntity.mid;
...
CREATE VIEW public.v_curso AS
 SELECT c.cid,
    c.nombre AS curso,
    m.mid,
    m.nombre AS materiaEntity,
    c.cupo,
    c.pid AS did,
    ((((('('::text || (d.legajo)::text) || ') '::text) || (pd.apellido)::text) || ', '::text) || (pd.nombre)::text) AS docenteEntity,
    c.descripcion,
    c.finicio,
    c.ffin,
    a.legajo,
    ...
    i.cfinal
   FROM ((((((public.curso c
     JOIN public.materiaEntity m ON ((c.mid = m.mid)))
     JOIN public.docenteEntity d ON ((c.pid = d.pid)))
...
CREATE VIEW public.v_persona AS
 SELECT p.pid,
   ...
   FROM ((public.persona p
     LEFT JOIN public.docenteEntity d ON ((p.pid = d.pid)))
...
--
-- Name: materiaEntity mid; Type: DEFAULT; Schema: public; Owner: sacusr
--

ALTER TABLE ONLY public.materiaEntity ALTER COLUMN mid SET DEFAULT nextval('public.materia_mid_seq'::regclass);
...
--
-- Data for Name: docenteEntity; Type: TABLE DATA; Schema: public; Owner: sacusr
--

COPY public.docenteEntity (pid, legajo) FROM stdin;
1	LD-10.001
17	LD-20.001
29	LD-30.001
\.
...
--
-- Data for Name: materiaEntity; Type: TABLE DATA; Schema: public; Owner: sacusr
--

COPY public.materiaEntity (mid, nombre, descripcion) FROM stdin;
...
--
-- Name: docenteEntity docente_legajo_key; Type: CONSTRAINT; Schema: public; Owner: sacusr
--

ALTER TABLE ONLY public.docenteEntity
    ADD CONSTRAINT docente_legajo_key UNIQUE (legajo);


--
-- Name: docenteEntity docente_pkey; Type: CONSTRAINT; Schema: public; Owner: sacusr
--
...
--
-- Name: materiaEntity materia_nombre_key; Type: CONSTRAINT; Schema: public; Owner: sacusr
--

ALTER TABLE ONLY public.materiaEntity
    ADD CONSTRAINT materia_nombre_key UNIQUE (nombre);


--
-- Name: materiaEntity materia_pkey; Type: CONSTRAINT; Schema: public; Owner: sacusr
--
...
--
-- Name: docenteEntity docente_pid_fkey; Type: FK CONSTRAINT; Schema: public; Owner: sacusr
--
...
ALTER TABLE ONLY public.materia_docentes
    ADD CONSTRAINT materia_docentes_mid_fkey FOREIGN KEY (mid) REFERENCES public.materiaEntity(mid);
...
ALTER TABLE ONLY public.materia_docentes
    ADD CONSTRAINT materia_docentes_pid_fkey FOREIGN KEY (pid) REFERENCES public.docenteEntity(pid);
